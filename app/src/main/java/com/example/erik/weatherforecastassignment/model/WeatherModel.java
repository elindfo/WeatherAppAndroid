...
public class WeatherModel {
    ...
    public List<WeatherForecast> getWeatherForecasts(double lon, double lat){
        ...
        long lastApprovedTime = weatherDatabaseAccess.findMaxApprovedTimeByLongitudeAndLatitude(lon, lat);
        //long currentTime = new Date().getTime();
        long currentTime = lastApprovedTime + 50000;
        if(currentTime - lastApprovedTime > 3600000){
